...
# Name:         ngcf
# Description:
# Author:       Zd Tinglin Huang (huangtinglin@outlook.com)
# Date:         2021/7/5
# -------------------------------------------------------------------------------
import torch
...
class NGCF(BaseModel):
	...
	def __init__(self, args_config):
		...
		self.n_users = args_config.n_users
		self.n_items = args_config.n_items
		self.adj_mat = args_config.adj_mat
		...
		self.device = args_config.devices[0]
		print(self.device)
		self.K = args_config.K
		# self.gnn = args_config.gnn
		# self.data_path = args_config.data_path
		"""
		*********************************************************
